...
/**
 * An {@link LdapAuthoritiesPopulator} that is based on the
 * {@link ActiveDirectoryLdapAuthenticationProvider}. The implementation obtains
 * the {@link GrantedAuthority}'s from the userData's memberOf attribute. It
 * then uses the last {@link LdapRdn}'s value as the {@link GrantedAuthority}.
 *
 * @author Rob Winch
