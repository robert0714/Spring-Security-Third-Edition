create table calendar_users (id integer generated by default as identity, email varchar(255), first_name varchar(255), last_name varchar(255), password varchar(255), primary key (id))
create table events (id integer generated by default as identity, description varchar(255) not null, summary varchar(255) not null, when timestamp not null, attendee integer, owner integer not null, primary key (id))
